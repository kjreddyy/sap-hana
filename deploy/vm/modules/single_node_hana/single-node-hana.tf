...
resource "null_resource" "destroy-vm" {
  provisioner "local-exec" {
    ...
    command = <<EOT
               ...
               --extra-vars="{az_resource_group: \"${module.common_setup.resource_group_name}\", az_vm_name: \"${local.linux_vm_name}\", config_json_file: \"../modules/single_node_hana/temp.json\"}" ../../ansible/delete_bastion_linux.yml
EOT
